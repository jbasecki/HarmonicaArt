...
function SuccessContent() {
  ...
  // These words will eventually be pulled from your database/webhook
  const stashedWords = ["RESTORED", "GOLDEN", "SANCTUARY"]; 
    ...
    <main style={{ minHeight: '100vh', background: '#000', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ textAlign: 'center', zIndex: 1 }}>
            ...
            return (
              <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ display: 'flex', gap: '4px' }}>
                   <div style={{ width: '40px', height: '60px', border: '1px solid gold', borderRadius: '8px', backgroundImage: `url(https://storage.googleapis.com/simple-bucket-27/vibes/${first}.png)`, backgroundSize: 'cover' }} />
                   <div style={{ width: '40px', height: '60px', border: '1px solid gold', borderRadius: '8px', backgroundImage: `url(https://storage.googleapis.com/simple-bucket-27/vibes/${penult}.png)`, backgroundSize: 'cover' }} />
                </div>
        ...
        <div style={{ marginTop: '50px' }}>
          <p style={{ color: 'gold', fontSize: '0.8rem', opacity: 0.6, letterSpacing: '2px' }}>the composition is stashed.</p>
        </div>
      </div>
    </main>
  );
